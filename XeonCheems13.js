...
break;
  case 'totalfeature':
        ...
        break
            ...
            let me = m.sender
            let xmenu_oh2 = ` ANYEONG ${pushname} 
☘︎
♲︎︎︎♲︎︎︎𝙳𝚄𝚇 𝘽𝙊𝙏 𝙄𝙉𝙁𝙊 
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"WhatsApp ☘️\",\"url\":\"https://chat.whatsapp.com/BZK6e00lnLL5t4aH9NfU4n\",\"merchant_url\":\"https://www.google.com\"}"
              },              
              {
  "name": "quick_reply",
...
"sellerJid": "2347082262014@s.whatsapp.net",
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
XeonBotInc.sendMessage("2347082262014@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
